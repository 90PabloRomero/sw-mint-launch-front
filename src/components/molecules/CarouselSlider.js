...
export class CarouselSlider extends React.Component {
  render() {
    return (
      <CarouselProvider naturalSlideWidth={775} naturalSlideHeight={125} totalSlides={3}>
        <Slider>
          <Slide index={0}>
...
export const CarouselScreenshotSlider = ({
  ...
  return (
    <CarouselProvider naturalSlideWidth={775} naturalSlideHeight={600} totalSlides={4}>
      <Slider>
        <Slide index={0}>
