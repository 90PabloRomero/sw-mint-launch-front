      ...
      <main className="market">
        <div className="hero grid place-center" style={{ paddingBottom: "0" }}>
          <div className=" grid place-center p-1" style={{ maxWidth: "800px" }}>
            ...
            <p className="mt-2">
              ESTA VERSION QUE PROBARAS A CONTINUACIÓN ES UN DEMO Y PUEDE QUE
              EXPERIMENTES DIFICULTADES SEGÚN LAS CARACTERÍSTICAS DE TU EQUIPO.
              CONTINUAMOS DÍA A DÍA DEPURANDO EL CÓDIGO Y REALIZANDO PRUEBAS
              PARA OPTIMIZAR EL CONSUMO DE RECURSOS Y LA FLUIDEZ DEL JUEGO.
            </p>
            <div>
              LO PRINCIPAL PARA SPACE WORMS SERÁ OFRECERTE PARTIDAS FLUIDAS Y
