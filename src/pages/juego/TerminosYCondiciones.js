      ...
      <main className="market" style={{maxHeight: "100vh"}}>
        ...
        <div className="hero grid place-center" style={{ paddingBottom: '0' }}>
          <TerminosYConditionsWrapper >
            ...
            <LegalContent>
              <p>
              Space Worms© (desde ahora SW) ... Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh
            ...
            <div style={{ textAlign: 'center' }}>
                <div><input type={"checkbox"} /> <span style={{fontSize: ".5rem"}}>No volver a mostrar</span></div>
              <a href="/demo/game.html" className="disable-styles">
                <AcceptButton className="game-btn mx-1">
                  ACEPTAR
                </AcceptButton>
              </a>
            </div>
