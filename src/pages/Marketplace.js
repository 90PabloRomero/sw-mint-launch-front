    ...
    <>
      ...
      <main className="market">
        ...
        <div className="hero" style={{ paddingBottom: '0' }}>
          <Header />
          <div className="game-wrapper market-layout" style={{ maxWidth: '100%' }}>
            <h1
              style={{
              ...
              <div className="p-1">
                ...
                <ul>
                  <li className="flex-wrapper">
                    <input type="checkbox" name="comun" id="list-comun" /> <span>Común</span>
                  </li>
                  <li className="flex-wrapper">
                    <input type="checkbox" name="comun" id="list-comun" /> <span>Poco Común</span>
                  </li>
                  <li className="flex-wrapper">
                    <input type="checkbox" name="comun" id="list-comun" /> <span>Raro</span>
                  </li>
                  <li className="flex-wrapper">
                    <input type="checkbox" name="comun" id="list-comun" /> <span>Legendario</span>
                  </li>
                </ul>
                <div
                  className="flex-wrapper pt-1"
                  ...
                  {listadatagusanos.map((gusanos) => (
                    ...
                    >
                      <div className="image-container">
                        <img src={gusanos.tokenimg} alt="" className="huevo-img" />
                      </div>
                      <div className="NFT-view-info-price">
                        <div style={{ fontWeight: '800', fontSize: '20px' }}>{gusanos.name}</div>
                        <div>{gusanos.tokenvalue} WBNB</div>
                        <div style={{ fontSize: '11px' }}>{gusanos.value} USD</div>
                      </div>
                    </button>
                  ))}
                </div>
